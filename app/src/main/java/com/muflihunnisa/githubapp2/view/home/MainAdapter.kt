...
import com.muflihunnisa.githubapp2.databinding.ItemUserBinding
...
class MainAdapter(private val listUser : List<ItemsItem?>?) : RecyclerView.Adapter<MainAdapter.MainViewHolder>() {
    ...
    inner class MainViewHolder(var itemUserBinding: ItemUserBinding) : RecyclerView.ViewHolder(itemUserBinding.root)
